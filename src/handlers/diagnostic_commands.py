...
from config import BOT_TOKEN, GENERAL_CHAT_ID, ADMIN_GROUP_ID
...
async def cmd_diag(message: Message):
    ...
    report += "📁 <b>Файлы:</b>\n"
    files = [
        ("data/users/users.txt", "Пользователи"),
        ("data/admins/admins.txt", "Администраторы"),
        ("data/roles_status.json", "Статусы ролей"),
        ("data/system_settings.json", "Настройки"),
        ("bot.db", "База данных")
    ]
